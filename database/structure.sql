...
CREATE TABLE "Yeu_cau_cap_nhat_thong_tin" (
  "id" INTEGER GENERATED BY DEFAULT AS IDENTITY UNIQUE NOT NULL,
  "trang_thai" VARCHAR(255),-- Chờ duyệt, Đã duyệt, Từ chối
...
CREATE TABLE "Ca_lam_viec_trong_tuan" (
  "id" INTEGER GENERATED BY DEFAULT AS IDENTITY UNIQUE NOT NULL,
  "ma_bac_si" varchar(9),
  "thu" VARCHAR(2), --T2, T3, T4, T5, T6, T7, CN
  "buoi_lam_viec" VARCHAR(255), --Sáng: 7-11h, Trưa 11-13h, Chiều 13-17h, Tối 17-19h
