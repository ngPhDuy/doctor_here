...
CREATE TABLE "Bac_si_thuoc_chuyen_khoa" (
  "ma_bac_si" varchar(9),
  "chuyen_khoa" VARCHAR(50),
  PRIMARY KEY ("ma_bac_si", "chuyen_khoa")
);
...
CREATE TABLE "Lan_uong" (
  ...
  PRIMARY KEY ("gio", "ngay", "don_thuoc"),
...
CREATE TABLE "Thuoc_trong_mot_lan_uong" (
  ...
  "thuoc" INTEGER,
  "so_luong" INTEGER,
  PRIMARY KEY ("gio", "ngay", "don_thuoc", "thuoc"),
  FOREIGN KEY ("gio", "ngay", "don_thuoc") REFERENCES "Lan_uong" ("gio", "ngay", "don_thuoc") ON DELETE NO ACTION ON UPDATE NO ACTION
);
...
ALTER TABLE "Cuoc_hen" ADD FOREIGN KEY ("ma_benh_nhan_dat_hen") REFERENCES "Benh_nhan" ("ma_benh_nhan") ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE "Bac_si_thuoc_chuyen_khoa" ADD FOREIGN KEY ("ma_bac_si") REFERENCES "Bac_si" ("ma_bac_si") ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE "Cuoc_hen" ADD FOREIGN KEY ("ma_bac_si") REFERENCES "Bac_si" ("ma_bac_si") ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- ALTER TABLE "Thuoc_trong_mot_lan_uong" ADD FOREIGN KEY ("gio") REFERENCES "Lan_uong" ("gio") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- ALTER TABLE "Thuoc_trong_mot_lan_uong" ADD FOREIGN KEY ("ngay") REFERENCES "Lan_uong" ("ngay") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- ALTER TABLE "Thuoc_trong_mot_lan_uong" ADD FOREIGN KEY ("don_thuoc") REFERENCES "Lan_uong" ("don_thuoc") ON DELETE NO ACTION ON UPDATE NO ACTION;

ALTER TABLE "Thuoc_trong_mot_lan_uong" ADD FOREIGN KEY ("thuoc") REFERENCES "Thuoc" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
