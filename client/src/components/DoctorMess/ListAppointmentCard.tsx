...
const ListAppointmentCard: React.FC<Props> = ({ data }) => {
  const navigate = useNavigate();

  if (!data || data.length === 0) return <p>Không có cuộc hẹn nào.</p>;

  return (
    <div className="w-full space-y-4">
      <p className="text-sm bg-gray-100 text-gray-700 px-4 py-2 rounded-md italic flex items-center gap-1">
        🗂️ <span>Dưới đây là danh sách các cuộc hẹn gần đây:</span>
      </p>
...
export default ListAppointmentCard;
