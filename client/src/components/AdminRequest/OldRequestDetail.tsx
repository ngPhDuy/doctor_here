...
const OldRequestDetail: React.FC = () => {
      ...
      <div className="flex gap-8">
        ...
        <div className="w-2/3 bg-white p-6 rounded-lg shadow-md">
          ...
          <div className="flex justify-center mt-10 mb-5">
            <div className="border rounded-lg px-5 py-3 text-green-700 bg-green-200">
              Chấp thuận
            </div>
          </div>
          <div className="flex justify-center mb-20">
            Được duyệt bởi Nguyễn Văn B
          </div>
        </div>
...
export default OldRequestDetail;
